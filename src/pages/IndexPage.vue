  ...
  <div class="q-pa-md">
    ...
    >
      <q-step
        ...
        :done="step > 1"
      >
        You must have a Web3 wallet like Metamask, Talisman, Subwallet or others
        installed.
      ...
      <q-step
        ...
        :done="step > 2"
      >
        Crust's IPFS API requires a signature of your EVM address for authorised
        use.
...
export default defineComponent({
  ...
  data() {
    return {
      step: ref(1),
      contractAddress: "0x6d4965CB654B039EfF3cC86400932338790C2126",
      contract: null,
      address: null,
      sig: null,
...
<style>
:root {
  --account-center-position-top: 45px;
  --account-center-position-right: -5px;
}
</style>
